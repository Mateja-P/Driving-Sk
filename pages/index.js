...
import hero2 from '../Images/Home/1Hero/hero2.jpg';
...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Auto Škola Avala Resnik - Početna</title>
        <meta
          name='description'
          content='Auto Škola Avala Resnik je novootvorena auto škola u Resniku i naš cilj je da polazinicima prenesemo teorisko i prakticno znanje tako da efikanso i po konkuretnoj ceni mogu doći do vozačke dozvole koju žele.'
        />
        ...
        <meta property="og:title" content="Auto Škola Avala Resnik - Početna" />
        <meta property="og:description" content="Efikasna i pristupačna obuka vozača u Resniku. Postanite vozač sa Auto Školom Avala." />
        <meta property="og:url" content="https://www.autoskolaavala.com" />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://www.autoskolaavala.com",
        ...
        <div className='w2'>
            ...
            <div className='!flex justify-between items-center gap-10 md:flex-col md:items-start px-2'>
              <div>
                <h1 className='capitalize hero-title'>
                  Nova Auto Škola Avala <br/>u Resniku
                </h1>
              ...
              <div className='md:flex md:w-full md:justify-center'>
                <div className='hero-img'>
                  <ImageComp src={hero2.src} triangleColor='border-x-[#fafafa]' alt='Auto Škola Avala Resnik' />
                </div>
              </div>
            </div>
            <div className='!flex justify-between items-center gap-10 md:flex-col md:items-start px-2'>
              ...
              <div className='md:flex md:w-full md:justify-center'>
                <div className='hero-img'>
                  <ImageComp src={hero1.src} triangleColor='border-x-[#fafafa]' />
                </div>
              </div>
            </div>
          </Slide>
          <div className='relative flex justify-end mt-20 gap-5 md:mt-10'>
            <div className='absolute left-[-70px] top-[-50px] xl:left-0 md:top-[-25px]'>
              <img className='w-[110px]' src={circledText.src} alt='Auto Škola Avala Resnik'/>
            </div>
          ...
          <div>
            <div>
              <h1 className='section-title mb-10 w-4/5 sm:w-full'>
                Auto Škola Avala u resniku kao deo vaše sigurnosti na putu
              </h1>
              <div className='flex'>
                ...
                <div className='px-5 lg:px-0 md:mb-10'>
                  ...
                  <p className='inter lg-text'>
                    Auto Škola Avala u resniku je novootvorena auto škola u Resniku i naš
          ...
          <div>
            ...
            <div className='mt-10'>
              <div>
                ...
                >
                  <img className='w-[20px] mr-2' src={blLocation.src} alt='Auto Škola Avala Resnik'/>
              ...
              >
                <img className='w-[20px] mr-2' src={blCall.src} alt='Auto Škola Avala Resnik'/>
        ...
        <div className='w2'>
          ...
          <div className='flex justify-between gap-32 2xl:gap-5 md:flex md:flex-col md:items-center md:gap-10'>
            ...
            <Card
              href='/lokacija'
              img={lokacijaImg.src}
              text='Auto Školu Avala možete naći na adresi Edvarda Griga 7 u Resniku ili možete pozvati preko telefona +381658701773.'
              title='Lokacija'
            />
            <Card
              href='/vozila'
        ...
        <div className='flex md:flex-col'>
          ...
          <div className='flex-1'>
            <div className='relative after:absolute after:w-full after:h-full after:left-0 after:top-0 after:bg-[rgba(0,0,0,0.65)] h-full'>
              <img className='h-full sm:h-[250px] sm:w-full' src={frImg.src} alt='Auto Škola Avala Resnik'/>
            </div>
          </div>
        </div>
        <div className='hidden lg:block bg-black w-full py-3'>
          ...
          >
            <div className='!flex items-center capitalize justify-center'>
              <img src={greenArrowImg.src} alt='Auto Škola Avala Resnik'/>
      ...
      <div className='py-40 sm:py-20'>
        <div className='flex w2 gap-10 md:flex-col'>
          <div className='flex-[0.7] flex flex-col justify-between lg:justify-evenly'>
            ...
            <img className='w-full md:w-1/2 sm:w-full' src={ftImg.src} alt='Auto Škola Avala Resnik'/>
          </div>
          <div className='flex-1 flex flex-col justify-between'>
            <div className='flex gap-5'>
              <div className='relative'>
                <img className='xs:w-[40px]' src={upisImg.src} alt='Auto Škola Avala Resnik'/>
              ...
              <div className='flex items-center'>
                <img src={rightarrowImg.src} alt='Auto Škola Avala Resnik'/>
              </div>
            </div>
            <div>
              <div className='flex relative gap-5 sm:my-5'>
                <div className='flex items-center'>
                  <img className='w-[190px]' src={leftarrowImg.src} alt='Auto Škola Avala Resnik'/>
                </div>
                <div>
                  <img className='xs:w-[40px]' src={teorijskiImg.src} alt='Auto Škola Avala Resnik'/>
                  <h3 className='text-xl font-medium mt-1 mb-2 xs:text-md'>
                    Teorijski deo
                  </h3>
                  <p className='lg-text'>
            ...
            <div>
              <div className='relative w-2/3 lg:w-full'>
                <img className='xs:w-[40px]' src={prakticniImg.src} alt='Auto Škola Avala Resnik'/>
                <h3 className='text-xl font-medium mt-1 mb-2 xs:text-md'>
                  Praktični deo
                </h3>
                <p className='lg-text'>
