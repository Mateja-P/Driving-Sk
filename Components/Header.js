  ...
  return (
    <div ref={headerRef}>
        ...
        <div className='flex justify-between lg:flex-col'>
          <div className='flex lg:flex-col'>
            <div>
              ...
              >
                <img className='h-ic mr-2' src={location_img.src} alt='Auto Škola Avala Resnik'/>
            ...
            <div className='flex items-center lg:my-4'>
              <img className='h-ic mr-2' src={clock_img.src} alt='Auto Škola Avala Resnik'/>
              <h4 className='uppercase text-white text-sm xs:text-xs'>
                radno vreme:
                <span className='capitalize text-green'>
                  {' '}
          ...
          <div>
            ...
            >
              <img className='h-ic mr-2' src={call_img.src} alt='Auto Škola Avala Resnik'/>
              <h4 className='uppercase text-white text-sm xs:text-xs'>
                pozovi na broj:{' '}
      ...
      <div className='flex justify-between items-center '>
        <div>
          <img className='w-[200px] xs:w-[150px]' src={logo.src} alt='Auto Škola Avala Resnik'/>
        </div>
        <div
        ...
        >
          <div className='md:flex md:flex-col py-4 px-10 lg:px-2 md:px-10 sm:px-5'>
            <Link
        ...
        <div
          className={`hidden md:flex md:flex-col md:justify-between md:w-5 md:h-5 transition-all relative right-[20px] duration-600 ease-in md:z-[999] ${
