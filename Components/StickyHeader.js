...
import call_img from '../Images/Others/call-gr.png';
...
const StickyHeader = ({ isVisible, usersPosition }) => {
  ...
  return (
    <div
      className={`w-full flex items-center justify-between bg-white z-[999] fixed transition-all delay-75 duration-700 ease-in-out ${
        isVisible ? 'top-0 ' : 'top-[-100%]'
      }`}
    >
      <div>
        <img className='w-[200px] sm:w-[170px]' src={logo.src} alt='Auto Škola Avala Resnik'/>
      </div>
      <div
      ...
      >
        <div className='lg:flex lg:flex-col px-5 py-5'>
          <Link
      ...
      <div
        className={`hidden lg:flex lg:flex-col lg:justify-between lg:w-5 lg:h-5 relative right-[20px] transition-all duration-600 ease-in ${
      ...
      <div onClick={() => call()} className='lg:hidden'>
        <div className='flex cursor-pointer items-center relative '>
          <div className='mr-4'>
            <img className='w-[40px]' src={call_img.src} alt='Auto Škola Avala Resnik'/>
          </div>
          <div className='pr-5'>
